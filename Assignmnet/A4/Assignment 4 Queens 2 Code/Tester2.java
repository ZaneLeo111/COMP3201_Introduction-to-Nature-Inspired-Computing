    ...
    public static void main(String[] args) {
        ...
        for (int count = 0; count < 10000; count++) {
            ...
            for (int index = 0; index < population1.length; index++) {
                if (fitness0 == fitnesses[index]) {
                    tally[index]++;
                }
                if (fitness1 == fitnesses[index]) {
                    tally[index]++;
                }
            }
        }
        ...
        for (int index = 0; index < population1.length; index++) {
            System.out
                    .println(index + ". rough expectation: " + expectedFrequency[index] + ", actual: " + tally[index]);
        }
        ...
        for (int index = 0; index < 10; index++) {
            System.out.print(index + ": Fitness: " +
                    Queens.measureFitness(population2[index]) + ", Genotype: ");
